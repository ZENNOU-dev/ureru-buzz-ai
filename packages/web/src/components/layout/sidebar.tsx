  ...
  return (
    <aside className="w-[220px] h-screen flex flex-col shrink-0 border-r border-white/[0.08]" style={{ background: "#151528" }}>
      ...
      <div className="px-5 pt-5 pb-3">
        <h1 className="text-xl font-black tracking-tight gradient-warm-text text-center">
          売れるBUZZ AI
        </h1>
        <p className="text-[10px] text-white/30 text-center tracking-widest mt-0.5">ZENOU</p>
      </div>
